...
export function Proyects() {
    return(
        <div id="ProyectFt"  className="w-full" style={{height:`${data.length * 200}px`}}>
            <h2  className="titleProyects">PROYECTS</h2>
            <div id="Proyects" className="containerProyect absolute"> 
                {data.map(item=> (
                <div id="cardsProyects" className="bg-neutral-950 border text-stone-50 border-stone-50 cardContainer max-w-xs rounded-2xl overflow-hidden">
